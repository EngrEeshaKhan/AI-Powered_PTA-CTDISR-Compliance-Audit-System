...
- Existing generic AI tools (ChatGPT, etc.) cannot be used directly for this because the source documents are sensitive/internal and cannot be uploaded to third-party 
